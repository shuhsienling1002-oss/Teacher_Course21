...
def main():
    ...
    <style>
        ...
        /* 提示框設計 (st.info, st.warning)：像是清涼的水波氣泡 */
        .stInfo {
            background-color: rgba(225, 245, 254, 0.85) !important;
            color: #0277bd !important;
            border-left: 6px solid #29b6f6 !important;
            border-radius: 10px;
            box-shadow: 0 2px 8px rgba(0,0,0,0.05);
        }
        .stWarning {
            background-color: rgba(255, 243, 224, 0.85) !important;
